function Inspector({ active, onSwitch, item, onNavigateReferrer, onUpdateSound, onUpdateSoundLoop, onRenameSound, onDeleteSound, onRenameBank, onReplaceBank, onExportBank, onDeleteBank, onUpdateGroup, onUpdatePlayer, onRenamePlayer, onDeletePlayer, onDeleteGroup, onDeleteArchive, onReplaceSound, onExportSound, onReplaceWave, onExportWave, onDeleteWave, onUpdateWave }) {
  ...
  return (
    <aside className="inspector">
      ...
      <div className="insp-body">
        {active === "props" && <PropertiesTab key={`props:${itemKey}`} item={item} onNavigate={onNavigateReferrer} onUpdateSound={onUpdateSound} onUpdateSoundLoop={onUpdateSoundLoop} onRenameSound={onRenameSound} onDeleteSound={onDeleteSound} onRenameBank={onRenameBank} onReplaceBank={onReplaceBank} onExportBank={onExportBank} onDeleteBank={onDeleteBank} onUpdateGroup={onUpdateGroup} onUpdatePlayer={onUpdatePlayer} onRenamePlayer={onRenamePlayer} onDeletePlayer={onDeletePlayer} onDeleteGroup={onDeleteGroup} onDeleteArchive={onDeleteArchive} onReplaceSound={onReplaceSound} onExportSound={onExportSound} onReplaceWave={onReplaceWave} onExportWave={onExportWave} onDeleteWave={onDeleteWave} onUpdateWave={onUpdateWave} />}
